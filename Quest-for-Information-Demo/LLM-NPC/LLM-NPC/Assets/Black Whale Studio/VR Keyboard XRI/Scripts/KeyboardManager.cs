...
namespace Keyboard
{
    public class KeyboardManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            // Switch to number keyboard by default
            OnSwitchPress();
        }
        ...
        private void OnDeletePress()
        {
            ...
            // Always delete from the end of the text
            int endPos = outputField.text.Length;

            if (endPos > 0)
            {
                outputField.text = outputField.text.Remove(endPos - 1, 1);
                outputField.selectionAnchorPosition = outputField.selectionFocusPosition = endPos - 1;
            }
